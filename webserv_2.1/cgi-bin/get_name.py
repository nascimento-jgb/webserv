...
first_name = form['first_name'].value if 'first_name' in form else None
print("%s" % first_name, file=sys.stderr)
last_name = form['last_name'].value if 'last_name' in form else None
print("%s" % last_name, file=sys.stderr)
...
print('\t</header>')
print('\t<main>')
# print('\t\tprint("<p>Welcome to our page %s %s!</p>" % (first_name, last_name))')
print('\t\t<p>Hope you have a nice ride!</p>')
print('\t\t<br>')
# print('\t\t\t<form action = "../cgi-bin/get_name.py" method = "post">')
